  ...
  return (
    <Con ref={top}>
      <div className="wrap">
        ...
        <p>
          Welcome to Industry Movers Corp. If you continue to browse and use
          ...
          policy govern IMC’s relationship with you in relation to this website.
          If you disagree with any part of these terms and conditions, please do
          not use our website.
        </p>
        <p>
          The term ‘INDUSTRY MOVERS CORP.’ or ‘us’ or ‘we’ refers to the owner
          of the website whose registered office is 1423 The Mondrian Building,
          Pablo Ocampo Sr., Ext. San Antonio Village, Makati City. Our Business
          TIN 009-988-088-000. is The term ‘you’ refers to the user or viewer of
          our website.
        </p>
        ...
        <ul>
          ...
          <li>
            ...
            of the website is subject to the laws of the Philippines.
          </li>
        </ul>
      </div>
    </Con>
